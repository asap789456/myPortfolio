...
function init_MoviePage () {
    ...
    //8. Toggle between cinemas timetable and map with location
   	...
   	//9. Init map with several markers on.
                    ...
                    var mapOptions = {
                        scaleControl: true,
                        center: new google.maps.LatLng(37.582170, 127.003828),
                        zoom: 15,
                        navigationControl: false,
                        streetViewControl: false,
                        mapTypeControl: false,
                    ...
                    var markerB = new google.maps.Marker({
                        map: map,
                        position: new google.maps.LatLng(37.582170, 127.003828)
                    });
...
function init_Cinema () {
    ...
    //4. Init map
                    ...
                    //Creates the information to go in the pop-up info box.
                    var boxTextA = document.createElement("div");
                    boxTextA.innerHTML = '<span class="pop_up_box_text">서울특별시 종로구 대학로12길 64, 유니스퀘어</span>';
