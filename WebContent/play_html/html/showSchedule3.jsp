				...
				<div class="tab-content">
						...
						<div class="time-select time-select--wide">
							<!-- 제목과 시간대 사이 거리조절 클래스 -->
								...
								<div class="col-sm-3">
									...
									<p class="time-select__place">라이어</p>
								</div>
								<ul class="col-sm-6 items-wrap">
								1회차: <li class="time-select__item" data-time='09:40'>17:00</li>	
								</ul>		
						</div>				
						</div>
					</div>
						...
						<div class="time-select time-select--wide">
							<!-- 제목과 시간대 사이 거리조절 클래스 -->
								...
								<ul class="col-sm-6 items-wrap">
									...
									1회차: <li class="time-select__item" data-time='09:40'>15:00</li>
									2회차: <li class="time-select__item" data-time='20:00'>17:30</li>	
					...
					<div role="tabpanel" class="tab-pane" id="messages">
							...
							<div class="time-select__group group--first">
								...
								<ul class="col-sm-6 items-wrap">
									1회차: <li class="time-select__item" data-time='09:40'>17:00</li>			
									2회차: <li class="time-select__item" data-time='09:40'>20:00</li>							
								</ul>		
						</div>
					</div>
				</div>
