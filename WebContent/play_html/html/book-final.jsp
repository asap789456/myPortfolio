...
/* 	-------------------예매가 되는 동안 자신의 이메일로 티켓이 보내질 때, 그 이메일의 내용--------------------------------------------- */
	String host = "http://www.apicket.com/play_html/html/";
	...
	String content = subject
			...
			+ "<tr>"
			+ "<td style='letter-spacing:10px'><div class='indecator-text pre--text'>입금안내: </td>"
			+ "<td><div class='indecator-text pre--text'>" + bank +"으로 7일 이내 입금해주세요" +"</td>"
			+ "</tr>"
                    ...
                    <div class="ticket-position">
                        ...
                        <div class="ticket__inner">
                            ...
                            <div class="ticket-secondary">
                                <span class="ticket__item">예매 번호 <strong class="ticket__number">AP<%=playDate%><%=cinemaNo%><%=playNo%><%=Result.substring(0, 1)%></strong></span>
                                <span class="ticket__item ticket__date"><%=playDate%></span>
                                <span class="ticket__item ticket__time">공연시작 시간: <%=time.substring(0,5)%></span>
