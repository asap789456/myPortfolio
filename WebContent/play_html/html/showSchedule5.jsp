...
<link href='http://fonts.googleapis.com/css?family=Roboto:400,700'
	rel='stylesheet' type='text/css'><!-- jQuery UI -->
<link
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="home">
						<div class="time-select time-select--wide">
								<!-- 제목과 시간대 사이 거리조절 클래스 -->
									<!-- 회색 박스 오브젝트 -->
								<center>
									<h5>월요일은 <strong style="color: red">바탕골소극장</strong> 정기 휴무일입니다.</h5>
								</center>		
					...
					<div role="tabpanel" class="tab-pane" id="profile">						
								...
								<div class="time-select__group group--first">
									<!-- 회색 박스 오브젝트 -->
									<div class="col-sm-3">
										<p class="time-select__place">터미널</p>
									</div>
									<ul class="col-sm-6 items-wrap">								
										1회차: <li class="time-select__item" data-time='09:40'>14:00</li>
										2회차: <li class="time-select__item" data-time='20:00'>16:30</li>	
					...
					<div role="tabpanel" class="tab-pane" id="messages">
							...
							<div class="time-select__group group--first">
								...
								<ul class="col-sm-6 items-wrap">
									1회차: <li class="time-select__item" data-time='09:40'>14:00</li>
									2회차: <li class="time-select__item" data-time='20:00'>16:30</li>											
									3회차: <li class="time-select__item" data-time='20:00'>19:30</li>	
					...
					<div role="tabpanel" class="tab-pane" id="profile">
							...
							<div class="time-select__group group--first">
								...
								<div class="col-sm-3">
									...
									2회차: <li class="time-select__item" data-time='20:00'>17:00</li>	
									3회차: <li class="time-select__item" data-time='20:00'>20:00</li>	
