...
<br>
	...
	<form method="post" id="frm" name="frm" action="admin_book1_time3.jsp">
        <section class="container">
            <div style="position: relative; top: -290px; left:500px;" class="col-sm-12">
                ...
                <div style="position: relative; top:-70px;" class="time-select time-select--wide"> <!-- 제목과 시간대 사이 거리조절 클래스 -->
	                <div style="width: 550px;height:100px; background-color: #f5f5f5"> <!-- 회색 박스 오브젝트 -->
            ...
            <div class="datepicker" style="position: relative; top: -350px; left:110px;">
	            <a class="datepicker__input" style="background-color: #" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
