...
<body>
	<!-- 관리자 페이지 - 극장 리스트를 전체 나열해서 보여주는 페이지 -->
<% 
   ...
   <!-- 검색기능 -->
	...
	<!-- Main content -->
		<section class="container">
			<div style="position: relative; top: -58px;" class="col-sm-12">
				<h2 class="page-heading">극장 조회</h2>
				<div class="cinema-wrap">
					<div class="row">
						...
						<div class="col-xs-6 col-sm-3 cinema-item name ing">
							<div class="cinema">
								<a href='adminTheaterUpdate.jsp?cinemaNo=<%=bean.getCinemaNo()%>'
								...
								<div style="padding-top: 10px;">
									...
									<a href='adminTheaterUpdate.jsp?cinemaNo=<%=bean.getCinemaNo()%>'
										...
										href="adminTheaterDelete.jsp?cinemaNo=<%=bean.getCinemaNo()%>"
